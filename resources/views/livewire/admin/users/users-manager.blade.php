            ...
            <div class="px-5 py-4 border-t border-gray-200 dark:border-white/[0.05] sm:px-6">
                <div class="flex items-center justify-between">
                    <p class="text-theme-sm text-gray-500 dark:text-gray-400">
                        Zobrazeno <span class="font-medium text-gray-800 dark:text-white/90">{{ $users->firstItem() }}</span>
                        až <span class="font-medium text-gray-800 dark:text-white/90">{{ $users->lastItem() }}</span>
                        z <span class="font-medium text-gray-800 dark:text-white/90">{{ $users->total() }}</span>
                    </p>
                    <div class="flex items-center gap-2">
                        ...
                        <span class="block text-sm font-medium text-gray-700 dark:text-gray-400 sm:hidden">{{ $users->currentPage() }} / {{ $users->lastPage() }}</span>
